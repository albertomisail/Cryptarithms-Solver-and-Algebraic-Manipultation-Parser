...
public class Repaired {
    ...
    //TODO
    //fails test 1
    //there is a problem in mRoot.size()
    /**
    ...
    private static class Node {
        ...
        public Node remove(int value) {
            ...
            if (value == mValue) {
                ...
                //TODO
                //whats this, apparenty it is right
        ...
        public boolean contains(int value) {
            ...
            //TODO
            //error, value is never checked for right branch
            if (value == mValue) {
                return true;
            }
        ...
        private Node singleRotateRight() {
            ...
            //assert(Math.abs(left.getHeight()-right.getHeight())<=1);
